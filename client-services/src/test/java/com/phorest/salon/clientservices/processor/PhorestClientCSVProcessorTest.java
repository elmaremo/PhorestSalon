...
public class PhorestClientCSVProcessorTest {
	...
	@Test(expected = PhorestCSVValidationException.class)
	public void testFailProcessCSV() {
		//Validate csv header changed from email to address
		StringBuilder str=new StringBuilder();
		str.append("id,first_name,last_name,Address,phone,gender,banned\n")
		...
		phorestClientCSVProcessor.processCSV(firstFile);
	}
	
	@Test(expected = PhorestCSVValidationException.class)
	public void testFailNoOfFieldsProcessCSV() {
		//Validate csv removed phone number
		StringBuilder str=new StringBuilder();
		str.append("id,first_name,last_name,Address,gender,banned\n")
		.append("e0b8ebfc-6e57-4661-9546-328c644a3764,Dori,Dietrich,patrica@keeling.net,Male,false\n")
		.append("104fdf33-c8a2-4f1c-b371-3e9c2facdfa0,Gordon,Hammes,glen@cummerata.co,Male,false");
